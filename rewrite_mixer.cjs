...
const renderMixerStart = html.indexOf('function renderMixer() {');
const renderMixerEnd = html.indexOf('function updateEditorUI() {', renderMixerStart);

const oldRenderMixer = html.substring(renderMixerStart, renderMixerEnd);
...
const oldCss = html.substring(cssStart, cssEnd + 8);
const newCss = oldCss.replace('</style>', `
...
console.log('Fixed Mixer UI manually');
